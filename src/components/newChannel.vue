<template lang="pug">
  div.bg-c-grey-0
    q-toolbar
      ...
      q-btn(flat round icon="check" @click="createChannel" :disable="!channelData.name || !channelData.description" :class="channelData.name && channelData.description?'text-primary':'c-grey-0'")
    q-card(flat)
