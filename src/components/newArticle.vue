      ...
      q-tab-panel(:style="heightStyle" name="default" class="q-pa-none")
        ...
        q-card(flat)
          q-card-section(align="center")
            ...
            P
            q-img(:src="$store.state.articleData.cover ? $store.state.articleData.cover : $store.defaultChannelArticleCover" style="height: 00px; width: 400px" class="cursor-pointer" @click="$refs.articleUpload.pickFiles()")
