<template lang="pug">
  q-layout(:style="heightStyle")
    q-page-container
      q-page
        q-toolbar
          q-btn(flat round dense icon="keyboard_arrow_left" @click="$store.changeBackupMigrationSubKind('default')")
          q-toolbar-title(align="center" style="padding-right:54px") {{$t('Backup and Restore')}}
        div
        ...
        q-page-scroller(expand position="top" :scroll-offset="150" :offset="[0, 0]")
          div(class="col cursor-pointer q-pa-sm bg-primary text-c-white text-center") {{$t('Scroll back up...')}}
</template>
<style lang="text/css" src="./../css/vue-markdown.css" />
<script src="./tip.vue.js" />